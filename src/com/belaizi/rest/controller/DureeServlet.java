...
public class DureeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(request.getParameter("inputAnnuite") != null && request.getParameter("inputCapital") != null && request.getParameter("inputTaux")  != null) {

		    AnnuiteRestClient annuiteRestClient= new AnnuiteRestClient();
		   	CreditModel creditModel =annuiteRestClient.getCapital(urlCapital, urlAnnuite, urlTaux);
		   	
		   	session.setAttribute("capitalResD", creditModel.getCapitalCre());
		   	session.setAttribute("dureeResD", creditModel.getDureeCre());
		   	session.setAttribute("tauxResD", creditModel.getTauxCre());
		   	session.setAttribute("annuiteResD", creditModel.getAnnuiteCre());
